                ...
                <div class="card bg-white py-5 d-md-down-none align-items-center" style="width:44%">
                    <div class="card-body w-custom-20 mt-custom-4">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            {{ csrf_field() }}
                            <div class="input-group mb-3 mt-custom-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="px-0">Remember me</label>
                                </div>
                                <div class="col-md-6 text-right">
                                    <a class="" href="#">Forgot password?</a>
                                </div>
                            </div>
                            <div class="row mt-custom-4">
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-primary w-custom-9 px-4">Login</button>
                                </div>
                                <div class="col-6 text-right">
                                    <a href="{{ route('register') }}" class="btn btn-light btn-outline-info w-custom-9">Register Now!</a>
                                </div>
                            </div>
                        </form>
                        </div>
